dc = LFADS.DatasetCollection('/data2/lfads/PierreEric/export_v02_broadbandRethreshNonSorted');
...
rc = LFADS.RunCollection('/data2/lfads/PierreEric/runs', 'oneVsTwo_0922_0921', dc);
...
%%
r = LFADS.Run('two0921_0922');
rc.addRun(r);
r.selectDatasets([6 7]);
r.prepareForLFADS();
